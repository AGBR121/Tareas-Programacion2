...
/*
Función PrintTriangle que imprime un triángulo de letras "P" con espacios.
...
void PrintTriangle(int counter){
    if(counter < 7){  // Condición para limitar las filas a 7
        PrintSpaces(33 + counter);  // Imprime los espacios al principio de la fila
        PrintLetter(13 - (counter * 2));  // Imprime la cantidad de letras "P" que corresponde a la fila actual
        PrintSpaces(33 + counter);  // Imprime los espacios al final de la fila
