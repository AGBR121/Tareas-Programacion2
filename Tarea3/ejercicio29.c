...
taylor, e imprime el resultado de la exponencial para esa x
- Salvedad: El programa solo funciona si se le ingresan un valor de x no mayor a 12 ni menor a -10 y un número de k entero positivo no 
